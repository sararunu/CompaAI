export function analyzeMood(text) {
  ...
  if (/enfadad|enojad|furios|molest[oa]|irritad[oa]|hart[oa]|rabia|odio|grrr/.test(lower)) return 'angry';
  ...
  if (/genial|bien|feliz|content[oa]|me alegra|excelente|perfecto|me gust|divertid|gracios[oa]|ja ja|jaja|jeje|risa/.test(lower)) return 'happy';
